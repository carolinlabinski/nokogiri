...
townhall_emails_clean = []
  ...
  townhallmails = page.xpath('/html/body/div/main/section[2]/div/table/tbody/tr[4]/td[2]')
...
hash = {}
  townhall_names.each_with_index do |key, index|
  hash[key] = townhall_emails_clean[index]
  end
